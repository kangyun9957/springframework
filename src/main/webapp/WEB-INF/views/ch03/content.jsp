...
<div class="card m-2">
	...
	<div class="card-body">
		<div class="card m-2">
			...
			<div class="card-body">
				<a class="btn btn-info btn-sm" href="method1?param1=문자열&param3=3.14&param4=true&param5=2021-08-27">요청</a>
				<hr />
				<form method="get" action="method1">
					...
					<div class="input-group">
						...
						<div class="btn-group btn-group-toggle" data-toggle="buttons">
							<label class="btn btn-secondary active"> <input type="radio" name="param4" checked value="true"> true
							</label> <label class="btn btn-secondary"> <input type="radio" name="param4" value="false"> false
							</label>
						</div>
					</div>
					<div class="input-group">
		...
		<div class="card m-2">
			...
			<div class="card-body">
				<form id="form1" name="form1">
					...
					<div class="input-group">
						...
						<div class="btn-group btn-group-toggle" data-toggle="buttons">
							<label class="btn btn-secondary active"> <input type="radio" id="radio1" name="param4" checked value="true"> true
							</label> <label class="btn btn-secondary"> <input type="radio" id="radio2" name="param4" value="false"> false
							</label>
						</div>
					</div>
					<div class="input-group">
			...
			<script>
            function requestGet() {
               const param1 = document.form1.param1.value;//폼에 접근해서 사용하는 방식
		...
		<div class="card m-2">
			<div class="card-header">필수 파라미터</div>
			<div class="card-body">
				<a href="method3?param1=문자열1&param2=문자열2" class="btn btn-info">요청</a>
			</div>
		</div>
		<div class="card m-2">
			<div class="card-header">디폴트 값을 갖는 파라미터</div>
			<div class="card-body">
				<a href="method4" class="btn btn-info">요청</a>
			</div>
		</div>
		<div class="card m-2">
			<div class="card-header">객체를 파라미터 값 받기</div>
			<div class="card-body">
